...
the above all the details are to be in JSON
        ...
        - all the dates must be print in the formart like yyyy-MM-dd
                for example:
                       if the date is like "09 Jul 21" means it should strictly print like "2021-07-09"
                so format and print the date like this format only for all the documents
...
so the i need to extract all the transcations and convert into JSON and print the accurate results for all the transcations for given document
        ...
        Instruction:
               ...
               - For empty fields, print only "None" don't print other than this
               - Strictly create a json for all the transactions and uploaded documents as per the instructions, don't skip transaction
{datas}
"""
